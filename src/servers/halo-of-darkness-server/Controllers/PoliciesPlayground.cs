...
public sealed class PoliciesPlayground
    : BaseController
{
    /// <summary>
    ...
    [HttpGet]
    [Route("custom-policy-from-builder")]
    ...
    [HttpGet]
    [Route("custom-policy-attribute")]
    public void CustomPolicyFromAttribute()
    {
        Ok();
    }
    ...
    private sealed class ProtectedResourceAttribute : AuthorizeAttribute
    {
